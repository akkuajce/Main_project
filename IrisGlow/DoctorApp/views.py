...
#     if not appointment.is_cancellation_allowed():
#         return HttpResponse("Cancellation not allowed")
...
#     # Deduct service fee and credit the account
#     # Assuming you have a method to handle this, let's call it handle_payment

#     # Send email notification
#     send_mail(
#         'Appointment Cancellation',
#         'Your appointment has been canceled. Service fee of Rs.100 has been deducted. Rs.200 will be credited to your account shortly.',
#         'irisgloweyecare@gmail.com',
#         [appointment.client.email],
#         fail_silently=False,
#     )

#     return HttpResponse("Appointment canceled successfully")
...
from django.http import HttpResponse
from .models import Appointments, TherapistAvailability
...
def cancel_appointment(request, appointment_id):
    ...
    # Free up the time slot in TherapistAvailability
    therapist_availability = TherapistAvailability.objects.filter(
        therapist=appointment.therapist,
        date=appointment.date,
        time_slot=appointment.time_slot
    ).first()
    if therapist_availability:
        therapist_availability.is_available = True
    ...
    send_mail(
        ...
        'irisgloweyecare@gmail.com',  # Replace with your email address
        [appointment.client.email],  # Send email to the client's email address
        fail_silently=False,
    )

    # Perform any other necessary operations like refunding, sending emails, etc.
